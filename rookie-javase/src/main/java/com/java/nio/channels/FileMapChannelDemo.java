...
/**
 * @Classname FileMapChannelDemo
 * @Description TODO
 * @Author rookie
 * @Date 2022/2/22 15:18
 * @Version 1.0
 */
public class FileMapChannelDemo {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        try {
            ...
            buf.put(bytes(msg));
            buf.flip(); // Use the HTTP error response
...
// All the buffers have been prepared; write 'em out
        while (out.write(gather) > 0) { // Empty body; loop until all buffers are empty
        }
        out.close();
